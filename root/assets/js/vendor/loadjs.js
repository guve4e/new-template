 ...
 */
	function loadFile (path, callbackFn, args, numTries) {
		...
		var preload = args.preload;

		var canPreload = (function () { try { return document.createElement("link").relList.supports('preload'); } catch (e) { return 0; } }());
		...
		if (beforeCallbackFn(path, e) !== false) {
			if (isCss) {
				doc.head.insertBefore(e, document.getElementById('main-stylesheet'))
			} else {
